public class Lesson18_5 {
    public static void main(String[] args) {
        ...
        System.out.println("Split list2 at index1.");
        DoublyLinkedList list3 = list2.split(1);
        ...
        System.out.println("Split list3 at index-1.");
        DoublyLinkedList list4 = list3.split(-1);
